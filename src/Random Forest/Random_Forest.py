...
if __name__ == '__main__':
    ...
    params = ['min_samples_leaf', 'min_samples_split',  'ccp_alpha', 'n_estimators', 'max_features']
    ranges = [range(2, 100, 10), range(2, 100, 10), np.linspace(0, 200.0, 10), range(1, 100, 10), np.linspace(0.1, 1, 5)]
